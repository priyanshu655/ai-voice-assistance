(function () {
    ...
    link.href = "https://nexusai-hg3u.onrender.com/assistant.css"
       ...
       <div class="shifra-top">
        ...
        <div class="shifra-bottom">
            ...
            <button class="shifra-mic">
               ...
               <img 
               src="https://nexusai-hg3u.onrender.com/mic.svg"
               alt="mic"
    ...
    button.innerHTML = `
    <img 
    src="https://nexusai-hg3u.onrender.com/logo.png"
    alt="logo"
    />`;
    ...
    const loadAssistant = async () => {
        try {
            const res = await fetch(`https://ai-voice-assistance-qnvj.onrender.com/api/assistant/config/${userId}`)
      ...
      recognition.onresult = (e)=>{
        ...
        setTimeout( async () => {
            try {
                ...
                const res = await fetch("https://ai-voice-assistance-qnvj.onrender.com/api/assistant/ask" , {
                    method:"POST",
                    headers:{
                        "Content-Type":
                      "application/json",
